...
var _ handlers.RenderClient = &RenderClientMock{}

// RenderClientMock is a mock implementation of handlers.RenderClient.
//
//     func TestSomethingThatUsesRenderClient(t *testing.T) {
//
//         // make and configure a mocked handlers.RenderClient
...
//         }
//
//         // use mockedRenderClient in code that requires handlers.RenderClient
...
// If this is not the case, regenerate this file with moq.
var _ handlers.SearchClient = &SearchClientMock{}

// SearchClientMock is a mock implementation of handlers.SearchClient.
//
//     func TestSomethingThatUsesSearchClient(t *testing.T) {
//
//         // make and configure a mocked handlers.SearchClient
...
//         }
//
//         // use mockedSearchClient in code that requires handlers.SearchClient
//         // and then make assertions.
//
//     }
