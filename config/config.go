...
func Get() (*Config, error) {
	...
	if newCfg.Debug {
		...
		newCfg.PatternLibraryAssetsPath = "//cdn.ons.gov.uk/dp-design-system/63ff7ca"
	}
...
func get() (*Config, error) {
	...
	cfg := &Config{
		...
		EnableCensusPopulationTypesFilterOption: true,
		EnableCensusDimensionsFilterOption:      true,
