...
| DATA_AGGREGATION_TOPICS_UPDATE_INTERVAL     | 30m                             | The time interval to update cache for data aggregation pages bar (`time.Duration` format)                           |
| ROOT_TOPIC_ID                               | 2257                            | Unique identifer for the root topic, used to get topics for the data aggregation pages from Topics API              |
